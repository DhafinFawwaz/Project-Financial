...
public static class ResolutionManager
{
    ...
    static Resolution[] _resolutions = new Resolution[6];
#elif UNITY_WEBGL
    static Resolution[] _resolutions = new Resolution[6];  
#elif UNITY_ANDROID
    ...
    public static void SetResolution(int resolutionIndex)
    {
        ...
        if(_resolutions.Length < resolutionIndex) {
            Debug.Log("For some reason the resolution is only " + _resolutions.Length + " but the choosen index is " + resolutionIndex);
            return;
        }
